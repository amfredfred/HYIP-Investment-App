  ...
  >
    <div class="deposit-page">
      ...
      <div class="transaction-table p-5 dark-bg--lighter">
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form
                  method="post"
                  @submit.prevent="add_user($event.target)"
                  v-if="!updating_user"
                >
                  <div class="row">
                    <div class="col-md-6">
                  ...
                  <div class="modal-footer justify-content-between">
                    ...
                    <button type="submit" class="btn btn-theme btn-circle">
                      Add
                    </button>
                  </div>
                </form>
        ...
        <!-- Edit user modal end -->
        <sva-loader
          v-if="loading_transactions || loading_referrals"
        ></sva-loader>
        <div class="table-responsive-sm">
          <table
            class="table"
            v-if="
              !loading_transactions && !loading_referrals && !shown_referrals
            "
          >
            <thead>
            ...
            <tbody>
              ...
              >
                <td>{{ index + 1 }}</td>
                <td @click="get_referrals(user.id)">
                ...
                <td>
                  <span v-if="user.can_withdraw == 0" class="text-success"
                    >Yes</span
                  >
                  <span v-if="user.can_withdraw == 1" class="text-danger"
                    >Blacklisted</span
                  >
                </td>
                ...
                <td>
                  <span v-if="user.code == 0" class="text-info"
                    >Unverified</span
                  >
                  <span v-if="user.code == 1" class="text-success"
                    >Verified</span
                  >
                </td>
                ...
                <td class="rounded-right border border-left-0">
                  <div class="dropdown dropleft">
                    ...
                    >
                      ...
                      <span
                        v-if="user.google2fa_secret_status == 1"
                        class="text-info"
                      >
                        <button
                          class="dropdown-item text-primary noHover"
                          type="button"
                        >
          ...
          <div
            v-if="
              !loading_referrals && !loading_transactions && shown_referrals
            "
          >
            <table class="table">
              <thead>
              ...
              <tbody>
                ...
                >
                  ...
                  <td>
                    ${{
                      user.refs.active_in[0] ? user.refs.active_in[0].total : 0
                    }}
                  </td>
                </tr>
              </tbody>
            </table>
            <button class="btn btn-info mt-3" @click="shown_referrals = false">
              Back
            </button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    get_referrals(referral_user_id) {
      ...
      const REQUEST_URL = `/user-referrals/${referral_user_id}`;
      axios
        .get(REQUEST_URL)
        .then((response) => {
          this.referrals = response.data.refs;
