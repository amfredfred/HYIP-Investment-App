                ...
                <div class="col-md-5 col-sm-7 m-auto p-md-5 p-3 c-login__the-form rounded" data-aos="fade-up">
                    <form id="register-user">
                        <div class="form-group">
                            ...
                            <i class="input__icon fa fa-user"></i>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <i class="input__icon fa fa-globe"></i>
                        </div>
                        <div class="form-group">
                            <label for="phone_no">Phone Number</label><input type="text" name="phone_no" id="phone_no"
                                                                             value="{{$number}}"   class="form-control form-input">
                            <i class="input__icon fa fa-phone"></i>
                        </div>
                        <div class="form-group">
                            <label for="bitcoin_address" class="form-label">Bitcoin Wallet Address</label>
                            <input type="text" id="bitcoin_address"class="form-control form-input">
                            <i class="input__icon fa fa-bitcoin"></i>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" id="confirm_password" class="form-control form-input">
                            <i class="input__icon fa fa-key"></i><br>
                        </div>
                        <div class="custom-control custom-checkbox mb-4">
                            <input type="checkbox" class="custom-control-input" id="check2">
                            <label class="custom-control-label" for="check2">Accept our <a  target="_blank" href="{{url('pages/terms-conditions')}}">Terms &
                                    Conditions</a></label>
                        </div>
                        <input type=hidden id="ref" value="{{$ref}}" class="form-control">
                        <div class="form-group">
                            <button id="sign" class="btn btn-primary px-5 py-2 mb-3"  >Sign up</button><br />
...
//                let message = 'Proccessing please wait';
