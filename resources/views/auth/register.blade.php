@section('title')
<title>{{ucfirst($settings['site_name'])}} - Register</title>
            ...
            <div class="row">
                <div class="col-md-7 col-md-offset-3">
                    <form id="register">
                        ...
                        <span class="input">
                            <select  name="country" id="country" class="input__field" style="color:#222!important">
                        ...
                        <span class="input">
                            <input class="input__field" type="tel" value="{{$number}}" name="phone_no" id="phone_no">
                            <label class="input__label" for="input-1">
                                <span class="input__label-content" data-content="Mobile Number">Mobile Number</span>
                            </label>
                        </span>
                        <span class="input">
                        ...
                        <span class="input">
                            <input class="input__field" type="password" id="confirm_password" >
                            <label class="input__label" for="input-1">
                        ...
                        <span class="input">
                            <input class="input__field"  id="bitcoin_address">
                            <label class="input__label" for="input-1">
                                <span class="input__label-content" data-content="Wallet Address">BTC Wallet Address</span>
                            </label>
                        </span>
                        <input type=hidden id="ref" value="{{$ref}}" class="form-control">
                        <div class="checkbox">
                            <label>
                                <input id="check2" type="checkbox"> I have read and accept {{ucfirst($settings['site_name'])}} 
                                <a   class="checkbox-link" target="_blank" href="{{url('pages/terms-conditions')}}">Terms &
                                    Conditions</a>
                            </label>
                        </div>

                        <button id="sign" class="btn btn-reg">Register</button>
                    </form>
                </div> 
            </div>
        </div>
...
<script>
    ...
    $('#register').submit(function (event) {
        ...
        if (checkbox.checked) {
            ...
            toastr.info("You Must agree to our Terms and Conditions!", {timeOut: 50000});
            return false;
        }
        $.ajaxSetup({
            headers: {
